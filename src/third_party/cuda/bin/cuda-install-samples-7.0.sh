...
if [ -z "$1" ]; then
    ...
    echo "Usage: cuda-install-samples-7.0.sh <target directory>";
    echo "       Will append NVIDIA_CUDA-7.0_Samples to <target directory>";
    exit 1;
fi
...
SAMPLES_DIR=$SAMPLES_DIR"NVIDIA_CUDA-7.0_Samples";
